...
llm_status llm_cuda_rope_position_f32(void *context, const float *input, const float *cos_table,
...
llm_status llm_cuda_attention_decode_f32(void *context, const float *query, const float *key,
